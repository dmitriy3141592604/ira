...
public class RandomizedTestTest implements RandomizedTest {
	...
	/**
	 * Тест спорный. Предсказать будущие значнения я не могу (это генератор _случайных_ чисел). Сохранить предыдущие значения я тоже не могу (в
	 * интерфейсе сохранить историю сложно.
	 *
